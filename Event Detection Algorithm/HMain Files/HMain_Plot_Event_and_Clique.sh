...
pythonScriptPath=/project/antares/lrootsel/montecarlo/HMain_Plot_Event_and_Clique.py

source /project/antares/lrootsel/montecarlo/Thoth/bin/activate

# Run the Python script with the configuration file
python HMain_Plot_Event_and_Clique.py "$configFilePath"


echo "Finished Running HMain_Plot_Event_and_Clique.sh Script"