echo "Running HMain_NMin_VEff_PanDepth.sh Script"
...
pythonScriptPath=/project/antares/lrootsel/montecarlo/HMain_NMin_VEff_PanDepth.py

source /project/antares/lrootsel/montecarlo/Thoth/bin/activate

# Run the Python script with the configuration file
python HMain_NMin_VEff_PanDepth.py "$configFilePath"


echo "Finished Running HMain_NMin_VEff_PanDepth.sh Script"