echo "Running HMain_NMin_VEff.sh Script"
...
pythonScriptPath=/project/antares/lrootsel/montecarlo/HMain_NMin_VEff.py

source /project/antares/lrootsel/montecarlo/Thoth/bin/activate

# Run the Python script with the configuration file
python HMain_NMin_VEff.py "$configFilePath"


echo "Finished Running HMain_NMin_VEff.sh Script"